...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <div className="hidden md:flex w-16 flex-col items-center border-r border-zinc-800 bg-zinc-900 py-4">
      ...
      {/* Mobile bottom bar */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 border-t border-zinc-800 bg-zinc-900 z-40 pb-[env(safe-area-inset-bottom)]">
